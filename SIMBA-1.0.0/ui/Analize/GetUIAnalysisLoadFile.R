...
GetAnalysisAnalizeSidebar <- sidebarPanel("",
          ...
          sliderInput("alpha","Significance Levels for ANOVA(alpha):",value=0.05,min=0.05,max=0.4,step=0.01),
          sliderInput("alphaFDR","FDR's alpha:",value=0.1,min=0.05,max=0.4,step=0.01),
